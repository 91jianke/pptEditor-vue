      ...
      <div class="dask" v-show="showImgBox">
         <div class="dialg">
            ...
            <div class="content">
               <div class="img-box">
                  <div class="imgs">
                     <span v-for="img in imageList" :key="img" @click="$emit('addComponent','image',{src:img.path||img.thumb})">
      ...
      <div class="dask" v-show="showSvgBox">
         <div class="dialg">
            ...
            <div class="content">
               <div class="img-box">
                  <div class="imgs">
                     <span v-for="svg in svgList" :key="svg" @click="$emit('addComponent','svg',{src:svg.path})">
      ...
      <div class="dask" v-show="showVideoBox">
         <div class="dialg">
            ...
            <div class="content">
               <div class="img-box">
                  <div class="imgs">
                     <span v-for="v in videoList" :key="v" @click="$emit('addComponent','video',{src:v.video_url})">
